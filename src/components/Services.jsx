...
const Services = () => {
  return (
    <section className="my-28 px-28 h-max pt-28 grid grid-cols-2">
      <div className="flex items-center justify-between flex-col pt-16`">
        <div className="w-full flex items-center justify-start gap-4">
          <span className="p-5 bg-black rounded-full text-white">
            <TbDeviceDesktopCode />
          </span>
      ...
      <div className="flex items-start flex-col justify-start">
        <span className="text-[20px] mb-8">Services</span>
